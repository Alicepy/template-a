    ...
    Plugin.prototype = {
        ...
        render: function () {
            ...
            if (format && format != "") {
                ...
                contentStr = '<div class="pick-show"><input type="hidden" value="" class="pick-area" readonly/><span class="pick-province">选择省</span><i>/</i><span class="pick-city">选择市</span><i>/</i><span class="pick-county">选择县</span><em class="pick-arrow"></em></div><ul class="pick-list"></ul>';
                this.format = "p/c/c"
            }
            if (setFormat) {
                var slash = 0,
                ...
                if (setFormat.match("province")) {
                    if (slash == 0) {
                        ...
                        strSpan = '<span class="pick-province">选择省</span><i>/</i><span class="pick-city">选择市</span>';
                        this.format = "p/c"
                    } else if (slash == 2) {
                        strSpan = '<span class="pick-province">选择省</span><i>/</i><span class="pick-city">选择市</span><i>/</i><span class="pick-county">选择县</span>';
                        this.format = "p/c/c"
                    }
        ...
        setVal: function (_this, aim, s) {
            ...
            if (s == "pro") {
                _this.ele.find(".pick-city").html("选择市");
                _this.ele.find(".pick-county").html("选择县");
