/**
 * 刻录OCX
 * 【OCX ClassID】 720515BD-4F59-451D-9F3A-4374CC849F2C
 * author:binyixian
 * modifyed:2017-12-11 15:31:46
 */
define([''], function () {
    return {
        burn: null,
        ...
        _onOcxEventProxy: function (data, callback) {
            ...
            console.log('onOcxEventProxy: ' + data);
            return data;
        },
        /**
         * 获取刻录进度
        ...
        getProcess: function () {
            ...
            var result = this.burn.BurnManager(data);
           // console.log('BurnGetProgress: ' + result);
            return result;
        }
    }
});